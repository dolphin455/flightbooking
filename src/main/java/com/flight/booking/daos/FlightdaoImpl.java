...
import com.flight.booking.entities.Seat;
import com.flight.booking.entities.UserBooking;
	...
	public List<Object[]> getBookingDetails(String pnr) {
		...
		if (list.size() != 0) {
			for(Object[] obj: list) {
				...
				System.out.println(obj[8] + " -- " + obj[8].getClass().getName());
				System.out.println((int)obj[1] + ((BigInteger) obj[8]).intValue());
			}
			return list;
		}
		return null;
